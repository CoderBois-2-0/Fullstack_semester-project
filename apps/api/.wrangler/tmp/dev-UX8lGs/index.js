...
var ne2 = /* @__PURE__ */ __name((left, right) => {
  return sql`${left} <> ${bindIfParam(right, left)}`;
}, "ne");
...
var signUpSchema = z2.object({
  role: z2.enum(["ADMIN", "ORGANISER", "GUEST"]),
  username: z2.string(),
...
var authRouter = new Hono2().use(async (c, next) => {
  ...
  const jwtToken = await sign2(user, c.env.JWT_SECRET);
...
// .wrangler/tmp/bundle-GJrAG4/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-GJrAG4/middleware-loader.entry.ts

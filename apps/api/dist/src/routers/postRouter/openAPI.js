import { postInsertSchema, postSelectSchema, postUpdateSchema, } from "@/db/handlers/postHandler";
...
const postPutRoute = createRoute({
    ...
    responses: {
        200: {
            description: "The post with the given id was updated with the provided data",
            content: {
                "application/json": {
                    schema: postResponseSchema,
                },
...
export { postGetRoute, postGetByIdRoute, postPostRoute, postPutRoute, postDeleteRoute, };

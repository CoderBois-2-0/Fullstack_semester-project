...
import { ticketSelectSchema, ticketInsertSchema, ticketUpdateSchema, } from "@/db/handlers/ticketHandler";
...
const ticketGetRoute = createRoute({
    description: "Retrieves all the tickets in the database, see query for filtering",
    tags: ["Tickets"],
    method: "get",
    path: "/",
    request: {
...
const ticketPutRoute = createRoute({
    description: "Will update the ticket with the given id, based on the provided body",
    tags: ["Tickets"],
    method: "put",
    path: "/:ticketId",
    request: {
...
export { ticketGetRoute, ticketGetByIdRoute, ticketPostRoute, ticketPutRoute, ticketDeleteRoute, };

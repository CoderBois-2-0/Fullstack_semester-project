import { commentInsertSchema, commentSelectSchema, commentUpdateSchema, } from "@/db/handlers/commentHandler";
...
const commentPutRoute = createRoute({
    description: "Updates the comment with the given id based on the provided body",
    tags: ["Comments"],
    method: "put",
    path: "/:commentId",
    request: {
...
export { commentGetRoute, commentGetByIdRoute, commentPostRoute, commentPutRoute, commentDeleteRoute, };

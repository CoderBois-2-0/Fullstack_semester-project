import { eventInsertSchema, eventSelectSchema, eventUpdateSchema, } from "@/db/handlers/eventHandler";
...
const eventPutRoute = createRoute({
    description: "Updates the event with the given id, based on the provided body",
    tags: ["Events"],
    method: "put",
    path: "/:eventId",
    request: {
    ...
    responses: {
        200: {
            description: "Found an event with the given id and updated it based on the provided body",
            content: {
                "application/json": {
                    schema: eventSelectSchema,
                },
...
export { eventGetRoute, eventGetByIdRoute, eventPostRoute, eventPutRoute, eventDeleteRoute, };
